...
def gen_test_suite():
    ...
    test_dir = os.path.abspath(os.path.dirname(__file__)) + os.sep + 'testcase\unitcase'
...
if __name__ == '__main__':
    ...
    filename = "F:\\Demo\\Demo_Git\\git-demo-autotest-guest\\report\\" + now + '_Unit_AutoTest_Report.html'
    fp = file(filename, 'wb')
    runner = HTMLTestRunner.HTMLTestRunner(
        stream=fp,
        title=u'单元测试_自动化测试报告',
